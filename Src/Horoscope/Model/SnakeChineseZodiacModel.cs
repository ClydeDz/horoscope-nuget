namespace Horoscope.Model
{
    internal class SnakeChineseZodiacModel : ChineseZodiacModel
    {
        ...
        {
            return new SnakeChineseZodiacModel("shé", ChineseZodiacSigns.Snake.ToString(), "Snake people love good books, food, music & plays. They have good luck with money.", ChineseZodiacElements.Fire);
        }
    }
}
